...
export class CarouselComponent {
  ...
  slides = [
    { image: 'asset/carousel/geomarketing.jpg', logo: 'asset/logos/Geomarketing-logo.jpg', description: ['Mapa digital para analizar clientes, puntos de venta y competencia con símbolos personalizados.', 'Combina datos propios, públicos y externos en una sola herramienta.', 'Realiza análisis avanzados con geo-audiencias utilizando APIs como Google Maps y Servihuella.', 'Capacidad de análisis en múltiples mercados a través de integración con APIs CARTO.'] },
    { image: 'asset/carousel/datarutas-a.jpg', logo: 'asset/logos/Datarutas-logo.jpg', description: ['Control de personal y vehículos, permitiendo una rápida respuesta a incidentes.', 'Machine Learning predictivo para anticipar sucesos y mejora la eficiencia operativa.', 'Permite crear rutas óptimas utilizando las coordenadas del mapa, considerando horarios y capacidades de entrega.', 'Visualiza rutas planeadas y ejecutadas para medir la eficiencia']},
    { image: 'asset/carousel/dataquiality.jpg', logo: 'asset/logos/Dataquality-logo.jpg', description: ['Precisión en la georreferenciación, validación y enriquecimiento de datos.', 'Mejora la calidad de los datos al adaptarse a diversas nomenclaturas con actualizaciones trimestrales.', 'Confdigura zonas o puntos cercanos para mejorar la precisión de la informaicón.', 'Cobertura en Latinoamérica, facilitando estrategías con datos relevantes en esta región.']}
  ];
